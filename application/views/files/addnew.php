...
.btn.btn-files{
  display: none;
    ...
    <div class="container-fluid">
        ...
        <div class="div-form other-info thesis" id="option-6" style="display:none;">
        <?php include 'thesis.php'; ?>
        </div>
        ...
        <div class="div-form other-info client" id="option-client" style="display:none;">
        ...
        <div class="div-form other-info end" id="option-end" style="display:none;">
        <button class="btn btn-success" onclick="skipAll()">Done</button>
        </div>
